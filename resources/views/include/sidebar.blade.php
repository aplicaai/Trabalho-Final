<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="{{route('dashboard')}}">
            <div class="logo-img">
               <img height="30" src="{{ asset('img/Sem Titulo-1.png')}}" class="header-brand-img" title="APLICAAI"> 
            </div>
        </a>
            ...
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item {{ ($segment1 == 'form-components' || $segment1 == 'form-advance'||$segment1 == 'form-addon') ? 'active open' : '' }} has-sub">
                    ...
                    <div class="submenu-content">
                        ...
                        <a href="{{url('carteira-aporte-listar')}}" {{ ($segment1 == 'form-addon') ? 'active' : '' }}>● {{ __('Compra/Venda')}}</a>
